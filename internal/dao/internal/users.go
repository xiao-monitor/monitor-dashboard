...
// UsersDao is the data access object for table xf_users.
...
// UsersColumns defines and stores column names for table xf_users.
type UsersColumns struct {
	UserUuid  string // 用户主键
	Username  string // 用户名
	Email     string // 用户邮箱
	Password  string // 用户密码
	Role      string // 用户所在角色
	IsEnable  string // 是否启用用户
	IsBan     string // 是否封禁
	CreatedAt string // 创建时间
	UpdatedAt string // 更新时间
}

// usersColumns holds the columns for table xf_users.
